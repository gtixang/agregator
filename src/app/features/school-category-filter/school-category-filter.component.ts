...
@Component({
  selector: 'app-school-category-filters',
  standalone: true,
  imports: [ReactiveFormsModule, CheckboxComponent],
  templateUrl: './school-category-filter.component.html',
  styleUrl: './school-category-filter.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SchoolCategoryFilterComponent implements OnInit {
