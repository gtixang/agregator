...
@Component({
  selector: 'app-online-courses-result',
  standalone: false,
  templateUrl: './online-courses-result.component.html',
  styleUrl: './online-courses-result.component.scss',
})
export class OnlineCoursesResultComponent {
  public courses: any[] = [
    {
      name: 'Профессия\nвеб-разработчик',
